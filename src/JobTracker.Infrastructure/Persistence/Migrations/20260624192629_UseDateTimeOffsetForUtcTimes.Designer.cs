...
namespace JobTracker.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260624192629_UseDateTimeOffsetForUtcTimes")]
    partial class UseDateTimeOffsetForUtcTimes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JobTracker.Domain.Companies.Company", b =>
                {
                    ...
                    b.Property<string>("NormalizedWebsite")
                        .HasMaxLength(500)
            ...
            modelBuilder.Entity("JobTracker.Domain.JobApplications.JobApplication", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("FollowUpOnUtc")
                        .HasColumnType("timestamp with time zone");
